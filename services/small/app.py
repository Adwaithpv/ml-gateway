"""FastAPI service for the Small model (Naive Bayes + TF-IDF).

Exposes prediction and health-check endpoints on port 8001.
"""
...
app = FastAPI(
    title="ML Gateway – Small Model",
    description="Naive Bayes + TF-IDF spam classifier",
    version="1.0.0",
)

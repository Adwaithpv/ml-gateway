"""FastAPI service for the Large model (LinearSVC + TF-IDF).

Exposes prediction and health-check endpoints on port 8003.
"""
...
app = FastAPI(
    title="ML Gateway – Large Model",
    description="LinearSVC + TF-IDF spam classifier (calibrated)",
    version="1.0.0",
)

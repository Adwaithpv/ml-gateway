"""Training script for the Medium model (Logistic Regression + TF-IDF).

Reads the UCI SMS Spam Collection dataset, trains a LogisticRegression pipeline,
...
def train(data_path: Path | None = None) -> None:
    """Train the Logistic Regression pipeline and persist the model."""
